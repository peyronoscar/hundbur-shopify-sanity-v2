...
import {
  SEARCH_INDEX_NAME,
  searchClient,
} from "@/storefront/lib/search-client";
import Hit from "@/storefront/components/search/components/hit";
import Hits from "@/storefront/components/search/components/hits";
import SearchBox from "@/storefront/components/search/components/search-box";
